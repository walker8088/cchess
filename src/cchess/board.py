...
# -----------------------------------------------------#
class ChessBoard(
    BoardState, BoardTransform, MoveGenerator, RuleChecker, AttackMatrixManager
):
    """棋盘核心类：存储棋子分布并提供走子/检测规则的工具方法。

    该类通过多重继承组合多个职责类，提供加载/导出 FEN、生成走子、检查将军/将死等功能。
    """
    ...
    def __init__(self, fen: str = "") -> None:
        ...
        """
        # 初始化父类
        BoardState.__init__(self, fen)
        AttackMatrixManager.__init__(self)

        # 如果提供了 FEN，使用完整的 FEN 解析
    ...
    def clear(self) -> None:
        ...
        # 调用父类的 clear 方法
        BoardState.clear(self)
        AttackMatrixManager.clear(self)
    ...
    def snapshot(self) -> "ChessBoard":
        ...
        # 复制攻击矩阵
        red_copy, black_copy, dirty = self.copy_attack_matrix()
        b.restore_attack_matrix(red_copy, black_copy, dirty)
        return b
    ...
    # make_move 方法已移至 MoveGenerator 类
    # 通过继承获得此方法

    # unmake_move 方法已移至 MoveGenerator 类
    # 通过继承获得此方法

    # move 方法已移至 MoveGenerator 类
    # 通过继承获得此方法

    # move_iccs 方法已移至 MoveGenerator 类
    # 通过继承获得此方法

    # move_text 方法已移至 MoveGenerator 类
    # 通过继承获得此方法

    # move_any 方法已移至 MoveGenerator 类
    # 通过继承获得此方法

    # next_turn 方法已移至 MoveGenerator 类
    # 通过继承获得此方法
    ...
    # is_checking 方法已移至 RuleChecker 类
    # 通过继承获得此方法

    # is_checkmate 方法已移至 RuleChecker 类
    # 通过继承获得此方法

    # has_no_legal_moves 方法已移至 RuleChecker 类
    # 通过继承获得此方法

    # count_x_line_in 方法已移至 RuleChecker 类
    # 通过继承获得此方法

    # count_y_line_in 方法已移至 RuleChecker 类
    # 通过继承获得此方法

    # x_line_in 方法已移至 RuleChecker 类
    # 通过继承获得此方法

    # y_line_in 方法已移至 RuleChecker 类
    # 通过继承获得此方法
